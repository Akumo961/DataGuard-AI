...
def upgrade() -> None:
    ...
    op.add_column("pia_records", sa.Column("payload", postgresql.JSONB(), nullable=False, server_default="{}"))
    ...
    op.add_column("remediation_items", sa.Column("evidence", postgresql.JSONB(), nullable=False, server_default="{}"))
    for table in ("pia_records", "remediation_items"):
