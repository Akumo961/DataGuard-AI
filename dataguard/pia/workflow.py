...
_ALLOWED: dict[PIAStatus, frozenset[PIAStatus]] = {
    ...
    PIAStatus.IN_REVIEW: frozenset({PIAStatus.REQUIRES_REMEDIATION, PIAStatus.APPROVED, PIAStatus.DRAFT}),
...
class PIAWorkflow:
    def transition(self, pia: PIA, target: PIAStatus, actor_id: str, reason: str = "") -> tuple[PIA, PIAHistoryEntry]:
        ...
        history = PIAHistoryEntry(
            pia_id=pia.pia_id, version=updated.version, from_status=pia.status,
            to_status=target, actor_id=actor_id,
