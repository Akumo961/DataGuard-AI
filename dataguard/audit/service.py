...
class AuditService:
    ...
    def create_record(
        self,
        *, event_id: str, timestamp: str, user_id: str, organization_id: str,
        action: str, object_type: str, object_id: str,
        previous_state: dict[str, Any] | None, new_state: dict[str, Any] | None,
        ip_address: str | None, request_id: str, result: str,
        previous_hash: str = "",
    ) -> AuditRecord:
        payload = {
            "event_id": event_id, "timestamp": timestamp, "user_id": user_id,
            "organization_id": organization_id, "action": action,
            "object_type": object_type, "object_id": object_id,
            "previous_state": previous_state, "new_state": new_state,
            "ip_address": ip_address, "request_id": request_id, "result": result,
