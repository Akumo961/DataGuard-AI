...
class Principal:
    ...
    def tenant_context(self) -> TenantContext:
        return TenantContext(self.organization_id, self.subject, frozenset(Role(role) for role in self.roles))
...
def get_principal(authorization: str | None = Header(default=None)) -> Principal:
    ...
    return Principal(subject=principal.subject_id, organization_id=principal.organization_id,
